  ...
  return (
    <div style={shellStyle}>
      ...
      <main id="main" style={mainStyle}>
        <span style={tagStyle}>404</span>
        <h1 style={titleStyle}>We couldn&rsquo;t find that page.</h1>
        <p style={bodyStyle}>
          The link may be broken, or the page may have moved. Here is a way
          back.
        </p>
        <div style={ctaRowStyle}>
          <Link href="/" style={primaryCtaStyle}>
            Go to homepage
          </Link>
